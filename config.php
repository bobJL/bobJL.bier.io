...
//======================================================================
	...
	define( "SITE_URL" , "https://demo.bierverteller.com" );
	# Your website URL

	define( "SRV_NAME" , "de bierverteller" );
    # Server or project name, will be used as title

    define( "SRV_SLOGAN" , "speciaalbieren met een verhaal" );
    # Server or project slogan, will be used as slogan and description

    define( "SRV_TWITTER" , "twitter" );
...
//======================================================================
    ...
    define( "STEAM_GID" , "103582791464704624" );
