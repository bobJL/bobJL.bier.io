...
<div class="container">
  <a class="navbar-brand" href="http://localhost/school/bierverteller/Rust-Server-Website-Template-master/" ></a>
...
<?php if(MODULE_SERVERS == "ON" OR MODULE_SERVERS_V2 == "ON"){ ;?>
      <li class="nav-item">
        <a class="nav-link" href="#servers">BierBoetiek</a>
      </li>
<?php };?>
<?php if(MODULE_COMMUNITY == "ON"){ ;?>
      <li class="nav-item">
        <a class="nav-link" href="#community">biervertellers</a>
      </li>
<?php };?>
<?php if(MODULE_DISCORD == "ON"){ ;?>
      <li class="nav-item">
        <a class="nav-link" href="#discord">bierproeverijen</a>
      </li>
<?php };?>
<?php if(MODULE_STORE == "ON"){ ;?>
      <li class="nav-item">
        <a class="nav-link" href="#store">prijzen</a>
      </li>
<?php };?>
